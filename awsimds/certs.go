...
// AWS public certificates for verifying EC2 instance identity documents.
// Sourced from https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/regions-certs.html
//
// Three maps by signature type. Key is region code.
// DSA certs verify PKCS7 signatures.
// RSA certs verify base64-encoded signatures.
// RSA-2048 certs verify RSA-2048 signatures.

var dsaCerts = map[string]string{
...
MIIC7zCCAq4CCQC5X6U+vgoLEDAJBgcqhkjOOAQDMFwxCzAJBgNVBAYTAlVTMRkw
FwYDVQQIExBXYXNoaW5ndG9uIFN0YXRlMRAwDgYDVQQHEwdTZWF0dGxlMSAwHgYD
VQQKExdBbWF6b24gV2ViIFNlcnZpY2VzIExMQzAgFw0yNDAxMDMxMjU3NTRaGA8y
...

...

...

...

...

...

...
7HX32MxXYruse9ACFBNGmdX2ZBrVNGrN9N2f6ROk0k9K
-----END CERTIFICATE-----`,
	"eusc-de-east-1": `-----BEGIN CERTIFICATE-----

RvdPXMFcMc6qrD0svAIVAMvsN3NwOY4KRYlFv9Dnok8D/ixI
-----END CERTIFICATE-----`,
}

var rsaCerts = map[string]string{
	"us-east-1": `-----BEGIN CERTIFICATE-----
...
var rsa2048Certs = map[string]string{
	"us-east-1": `-----BEGIN CERTIFICATE-----
...
var (
	certOnce           sync.Once
	dsaCertPool        []*x509.Certificate
	rsaCertPool        []*x509.Certificate
	rsa2048CertPool    []*x509.Certificate
	allCertPool        []*x509.Certificate
)

func certPool() []*x509.Certificate {
	certOnce.Do(func() {
		dsaCertPool = parseCertMap(dsaCerts)
		rsaCertPool = parseCertMap(rsaCerts)
		rsa2048CertPool = parseCertMap(rsa2048Certs)
		allCertPool = append(allCertPool, dsaCertPool...)
		allCertPool = append(allCertPool, rsaCertPool...)
		allCertPool = append(allCertPool, rsa2048CertPool...)
	})
	return allCertPool
}

func parseCertMap(m map[string]string) []*x509.Certificate {
	var certs []*x509.Certificate
	for region, raw := range m {
		rest := []byte(raw)
		for {
			var block *pem.Block
			...
			if err != nil {
				panic(fmt.Sprintf("awsimds: failed to parse certificate for region %s: %v", region, err))
			}
